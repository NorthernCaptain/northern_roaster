// ==============================================================
// Oracle, ODBC and DB2/CLI Template Library, Version 4.0.111,
...
#define OTL_VERSION_NUMBER (0x04006FL)
...
#ifndef OTL_UTF8_MAX_BYTES
#define OTL_UTF8_MAX_BYTES 1
#endif
...
#endif
   default:
     return (maxsz * OTL_UTF8_MAX_BYTES) +1;
   }
#if defined(OTL_BIGINT)
  case SQL_C_SBIGINT:
